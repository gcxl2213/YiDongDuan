...
public class MainFragment extends Fragment {
    ...
    private void getData() {
        ...
        HttpUtil.getCoursesList(new BaseObserver<CoursesListBean>() {
            @Override
            protected void onSuccess(CoursesListBean coursesListBean) {
                if (coursesListBean.getCode().equals("20000")) {
    ...
    private void initView() {
        ...
        mAdapter.setOnItemClickListener((view, position) -> {
            ...
            intent.putExtra("courseId", String.valueOf(data.get(position).getId()));
            intent.putExtra("courseNum", String.valueOf(data.get(position).getCourseNum()));
